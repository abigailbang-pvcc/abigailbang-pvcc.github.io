...
#       --Eligibility: Owned or leased vehicles which are predominately used for non-buisness purposes & have passsenger license plates
...
def display_results():
    ...
    for i in range(num_vehicles):
        ...
        dataline2 = pptr_elegible[i] + tab + format(ppt_owed[i],moneyf)
